...
const RandomTool: React.FC = () => {
    ...
    return (
        <ToolLayout
            ...
            direction="vertical"
        >
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1.5rem', height: '100%', minHeight: 0 }}>
                {/* Random Numbers Section */}
                <div style={{ padding: '1.25rem', background: 'var(--bg-secondary)', borderRadius: '12px', border: '1px solid var(--border-color)', display: 'flex', flexDirection: 'column' }}>
                    ...
                    <button onClick={generateRandomNumbers} style={{ width: '100%', background: 'var(--accent-primary)', color: 'white', padding: '10px', borderRadius: '6px', fontWeight: 600, marginTop: 'auto' }}>
                        生成数字
                    </button>
                </div>
                ...
                <div style={{ padding: '1.25rem', background: 'var(--bg-secondary)', borderRadius: '12px', border: '1px solid var(--border-color)', display: 'flex', flexDirection: 'column' }}>
                    ...
                    <button onClick={generateUuids} style={{ width: '100%', background: 'var(--accent-secondary)', color: 'white', padding: '10px', borderRadius: '6px', fontWeight: 600, marginTop: 'auto' }}>
                        生成 UUID
                    </button>
                </div>
            </div>
            ...
            <ToolPane
                ...
                extra={
                    <div style={{ display: 'flex', gap: '10px' }}>
                        <button onClick={handleCopy} style={{ color: 'var(--accent-primary)', fontSize: '0.75rem', display: 'flex', alignItems: 'center', gap: '4px' }}>
                            <Copy size={14} /> 复制全部
                        </button>
                        <button onClick={() => setOutput('')} style={{ color: 'var(--error-color)', fontSize: '0.75rem', display: 'flex', alignItems: 'center', gap: '4px' }}>
                            <Trash2 size={14} /> 清空
                        </button>
                    </div>
                }
